      ...
      <div className="mx-auto bg-green-400 rounded-xl shadow-lg">
        <div className="grid lg:grid-cols-2 gap-5 lg:gap-14 sm:p-8 p-4">
          <div className="text-start">
            ...
            <p className="text-sm text-gray-50 mt-4 leading-relaxed">
            ...
            <ul className="mt-5 lg:mt-12 space-y-4 lg:space-y-8">
              ...
              <li className="flex items-center justify-start">
                <a
                  href={whatsappUrl}
                  className="text-decoration-none flex items-center justify-start text-white text-sm"
                  target="_blank"
                ...
                >
                  ...
                  <span className="ms-4">+8615616256736</span>
                </a>
              </li>
              <li className="flex items-center justify-start">
                <svg
          ...
          <div className="bg-white shadow-lg p-5 rounded-lg">
            ...
            <div className="space-y-4 max-lg:mt-4">
              <button
                ...
                type="button"
                className={`w-full block md:w-auto md:inline px-4 py-2 rounded-lg text-sm tracking-wider font-medium outline-none border-2 border-green-600 mr-4 ${
                  interest === "Marketing"
            ...
            <form className="mt-4 md:mt-8 space-y-4" onSubmit={handleSubmit}>
              ...
              {statusMsg && (
                <div
                  className={`${
                    status
                      ? "bg-green-100 py-2 px-3 rounded"
                      : "bg-red-100 py-2 px-3 rounded"
                  }`}
                >
                  <span>{statusMsg}</span>
                </div>
              )}
              <button className="text-white bg-green-600 hover:bg-green-800 tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16px"
                  height="16px"
