  ...
  return (
    <Container id="contact">
        <div className="mx-auto bg-green-400 rounded-xl shadow-lg">
            <div className="grid lg:grid-cols-2 gap-5 lg:gap-14 sm:p-8 p-4">
                <div className="text-start">
                    <h1 className="text-2xl md:text-4xl font-bold text-white">Get in Touch</h1>
                    ...
                    <ul className="flex justify-start mt-5 lg:mt-12 space-x-1 md:space-x-4">
                ...
                <div className="bg-white shadow-lg p-5 rounded-lg">
                    ...
                    <div className="space-y-4 max-lg:mt-4">
                        <button onClick={()=>setInterest("Marketing")} type="button" className={`w-full block md:w-auto md:inline px-4 py-2 rounded-lg text-sm tracking-wider font-medium outline-none border-2 border-green-600 mr-4 ${interest ==="Marketing" ? "bg-green-600 text-white":"bg-transparent text-gray-800"}`}>Marketing</button>
                        <button onClick={()=>setInterest("Fund Raising")} type="button" className={`w-full block md:w-auto md:inline px-4 py-2 rounded-lg text-sm tracking-wider font-medium outline-none border-2 border-green-600 mr-4 ${interest ==="Fund Raising" ? "bg-green-600 text-white":"bg-transparent text-gray-800"}`}>Fund Raising</button>
                        <button onClick={()=>setInterest("Cex Listing")} type="button" className={`w-full block md:w-auto md:inline px-4 py-2 rounded-lg text-sm tracking-wider font-medium outline-none border-2 border-green-600 mr-4 ${interest ==="Cex Listing" ? "bg-green-600 text-white":"bg-transparent text-gray-800"}`}>Cex Listing</button>
                    </div>

                    <form className="mt-4 md:mt-8 space-y-4" onSubmit={handleSubmit}>
                        ...
                        <textarea onChange={handleMessageChange} placeholder='Message' rows="6"
                            ...
                            {statusMsg && <div className={`${status ? "bg-green-100 py-2 px-3 rounded": "bg-red-100 py-2 px-3 rounded"}`}><span>{statusMsg}</span></div>}
                        <button
